...
class TrojanMap {
 ...
 public:
  ...
  std::vector<std::string> IsInSubgraph(std::vector<double> &square,std::vector<std::string> input);
  ...
  void Tsort(std::pair<std::string,bool> &m, std::vector<std::pair<std::string,bool>> &visited,std::vector<std::string> &stack, std::vector<std::vector<std::string>> &dependencies);
  ...
  void TTB_Aux(std::string start,std::vector<std::string> location_ids,std::string cur_node,
  ...
  std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_Backtracking(
      std::vector<std::string> location_ids);
  std::vector<std::string> two_opt_swap(std::vector<std::string> cur_path, int indexi, int indexk);
  std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_2opt(
      std::vector<std::string> location_ids);
  std::vector<std::string> three_opt_swap(std::vector<std::string> cur_path, int indexi, int indexk);
...
bool visited = false;
  ...
  void bellman_ford_helper(std::unordered_map < std::string, int> &distance, std::unordered_map < std::string, std::string> &predecesor, std::string &src);
  void getconnectedsubgraph(std::string &dst,std::vector<std::string> &edge_nodes,std::vector<std::string> &nodes,std::unordered_map< std::string , bool> &valid);
  bool iscycle(std::string src,std::string parent,std::unordered_map<std::string,bool> &visited,std::unordered_map<std::string,std::vector<std::string>> &adj,std::vector<std::string> &cycle_nodes);
  bool CycleDetectionHelper(std::string &id, std::unordered_map<std::string, bool> &isVisited, std::string parent, std::vector<std::string> &path);
  bool CycleDetection(std::vector<std::string> &subgraph, std::vector<double> &square,  std::vector<std::string> &path);
};
